...
\name{Ryan}{Kelly}
\position{Software Engineer{\enskip\cdotp\enskip}Embedded}
\address{2013 McKinney Rd., Monroeville, PA 15146}

\mobile{(724)504-2471}
\email{somerkelrpk@gmail.com}
%\dateofbirth{November 21st, 1994}
%\homepage{www.posquit0.com}
\github{ryankelly2}
\linkedin{ryankellypsu}
% \gitlab{gitlab-id}
